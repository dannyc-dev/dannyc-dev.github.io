...
function Barena(props) {
    ...
    return (
        <div className="blog-body">
            ...
            <div className='blog-p'>
                ...
                <div className="blog-list-header">Tooling Specs:</div>
                    <ul className="blog-list">
                        ...
                        <li>IDA Home (free version also works)</li>
                        <li>Cheat Engine (optional but it wouldn't be game hacking post without mentioning it at least once)</li>
                    </ul>
                </div>
            </div>
            ...
            <div className='blog-p'>
                I tried to design the simplest game I could while still giving the player some control over key game loop inputs. Each turn (or tick), the player is faced with a decision to attack the opponent or try to heal themselves with a potion. The enemy player will mirror whatever you decide, so choose wisely. Although the rules of the game are simple, it gives us just enough control to make altering the game state interesting. Let's get to the fun stuff.
            </div>
