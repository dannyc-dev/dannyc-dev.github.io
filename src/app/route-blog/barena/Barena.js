    ...
    return (
        <div className="blog-body">
            ...
            <div className="blog-p">
                ...
                These projects were built in Visual Studio 2022 on Windows 11 v10.0.22000 (sorry Mac fans, Windows only for this one). In Visual Studio, open the solution file of each project to build the project from source or head over to the github release pages and download the binaries directly - <a target="_blank" rel="noreferrer" href="https://github.com/dannyc-dev/Battle-Arena-In-Memory/releases/">Battle Arena Game Releases</a>, and <a target="_blank" rel="noreferrer" href="https://github.com/dannyc-dev/Battle-Arena-Trainer/releases/">Battle Arena Trainer Releases</a>.
