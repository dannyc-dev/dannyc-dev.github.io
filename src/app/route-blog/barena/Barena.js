...
function Barena(props) {
    ...
    return (
        <div className="blog-body">
            ...
            <div className='blog-p'>
                The first thing I did was open the game file (found in the default build path <code> x64/Debug/battle_arena.exe</code> after you build the project) in IDA. In the main function, we see a call for loading the effective address of the player (and enemy) that IDA resolves for us. The snippets of interesting disassembly bits can be found below as well as the disassembly from IDA which has the full context:
